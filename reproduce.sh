...
xcodebuild EXCLUDED_ARCHS=x86_64  -project Hybrid.xcodeproj -destination 'generic/platform=iOS Simulator' -scheme Hybrid  -sdk "iphonesimulator" -derivedDataPath DD > build.log
